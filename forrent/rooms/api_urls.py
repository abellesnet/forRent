...
from rooms.api_views import RoomBookingViewSet, RoomRatingViewSet, RoomCommentViewSet, RoomViewSet, RoomAmenityViewSet
...
router.register(r'amenity', RoomAmenityViewSet, base_name='roomamenity')
